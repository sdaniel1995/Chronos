...
const timeUri = "http://localhost:8080/chronos.com/employeeTime";
...
(async() => {
  ...
  for (let index = 0; index < tSheets.length; index++) {
    ...
    cell1.innerHTML = date.getMonth() + "/" + date.getDate() + "/" + date.getFullYear();
    cell2.innerHTML = tSheets[index].totalHours.toFixed(2);
    cell3.innerHTML = tSheets[index].status;
  }
})();
